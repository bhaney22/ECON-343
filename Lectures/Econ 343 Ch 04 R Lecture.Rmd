...
pval_1 <-   pt(-1*abs(tstat),df) # obtain one-sided p-value
pval_2 <- 2*pt(-1*abs(tstat),df) # obtain two-sided p-value
```
...
To test the $H_0: \hat\beta_1 = 1$ against the two-sided alternative, 
