...
lm.mydata <- mydata %>% select(teamwork, AGE,femail,collgrad,faminc2018,EDUC,WTSSALL)
...
# Example - replace this regression model with your own.
# Be sure to use the command "weights = WTSSALL" in your regression

lm1 <- lm(teamwork ~ EDUC + AGE + female + collgrad + faminc2018, 
          data = lm.mydata,
          weights = WTSSALL)
